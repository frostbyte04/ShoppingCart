...
import com.gs.service.impl.UserSecurityService;
import com.gs.utility.IndiaConstants;
import com.gs.utility.MailConstructor;
...
public class HomeController {
    ...
    @RequestMapping("/guitarshelf")
    public String guitarshelf(Model model, Principal principal) {
    ...
    public String guitarDetail(
            @PathParam("id") Long id, Model model, Principal principal) throws Exception {
        if (principal != null) {
            String username = principal.getName();
            User user = userService.findByUsername(username);
            model.addAttribute("user", user);
    ...
    public String myProfile(Model model, Principal principal) {
        ...
        List<String> stateList = IndiaConstants.listOfIndianStatesCode;
    ...
    public String updateUserShipping(
        ...
        if(user.getId() != userShipping.getUser().getId()) {
            ...
            model.addAttribute("userPaymentList", user.getUserPaymentList());
            model.addAttribute("userShippingList", user.getUserShippingList());        model.addAttribute("orderList", user.getOrderList());
            model.addAttribute("orderList", user.getOrderList());
