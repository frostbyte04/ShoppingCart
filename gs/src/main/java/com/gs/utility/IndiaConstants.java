...
public class IndiaConstants {
    ...
    public final static List<String> listOfIndianStatesCode = new ArrayList<>(mapOfIndianStates.keySet());
    public final static List<String> listOfIndianStatesName = new ArrayList<>(mapOfIndianStates.values());
}
